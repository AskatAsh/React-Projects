...
<i>Here greetings and greetign are not the same variable. greeting is initialized with let but greetign is not. So, greetign is undefined that's why RefenceError</i>
